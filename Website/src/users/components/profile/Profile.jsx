...
function Profile() {
  ...
  const joined = useMemo(() => {
    try {
      return new Date(profileData.joinedDate).toLocaleDateString();
    } catch {
      return "—";
    }
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-900">
      ...
      {/* 
        Layout behavior:
        - Mobile: full-width, normal flow, content optimized for phone width
        - Desktop: centered both horizontally + vertically, and constrained to a nice max width
      */}
      <div
        className="
          w-full
      ...
      >
        {/* Content wrapper:
            ...
            - Desktop: fixed readable width, centered
        */}
        <div
          className="
            w-full
            ...
            <div className="p-0 md:p-6 lg:p-8">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-4 gap-4">
                      <div className="group rounded-2xl bg-gray-50 dark:bg-gray-700/60 ring-gray-200 dark:ring-gray-700 p-4 shadow-sm flex flex-col items-center transition hover:-translate-y-0.5 hover:shadow-md">
                        <span
                          ...
                          style={{
                            background: colors.primary?.light || "#dbeafe",
                            color: colors.primaryText || "#0f172a",
                          }}
                        >
                          {(profileData.role || "customer").toUpperCase()}
                        </span>
                      ...
                      <div className="group rounded-2xl bg-gray-50 dark:bg-gray-700/60 ring-gray-200 dark:ring-gray-700 p-4 shadow-sm flex flex-col items-center transition hover:-translate-y-0.5 hover:shadow-md">
                        ...
                        >
                          {(profileData.status || "active").toUpperCase()}
                        </span>
              ...
              <div>
                <div className="space-y-6">
                  {/* Profile Card */}
                  <div className="bg-white dark:bg-gray-800 shadow-lg ring-gray-200 dark:ring-gray-700 overflow-hidden transition-all duration-300 hover:shadow-2xl w-full max-w-full md:rounded-3xl">
                    {/* Animated top accent */}
                    <div
                        ...
                        <div className="relative">
                          ...
                          {isEditing && (
                            <button
                              type="button"
                              className="
                                group absolute -bottom-2 -right-2 bg-blue-600 text-white p-2.5 rounded-2xl
                                shadow-sm ring-blue-600/20
                                hover:bg-blue-700 hover:shadow-lg hover:-translate-y-[1px]
                              ...
                              "
                              onClick={() =>
                                toast("Upload hook not wired yet", {
                                  icon: "📷",
                                })
                              }
                            >
                              ...
                              <div className="group flex items-start gap-3 rounded-2xl bg-gray-50/60 dark:bg-gray-700/60 ring-gray-200 dark:ring-gray-700 p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                                ...
                                <div className="flex-1 min-w-0">
                                  <p
                                    ...
                                    style={{
                                      color: colors.secondaryText || "#334155",
                                    }}
                                  >
                                    Email
                                  </p>
