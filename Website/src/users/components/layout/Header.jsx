...
export const Header = () => {
  ...
  const navLinks = [
    { name: 'Home', path: '/app', icon: <Home className="w-4 h-4" /> },
    { name: 'Services', path: '/app/services', icon: <Briefcase className="w-4 h-4" /> },
    { name: 'Professionals', path: '/app/professionals', icon: <Users className="w-4 h-4" /> },
    { name: 'About', path: '/app/about', icon: <Info className="w-4 h-4" /> },
    { name: 'Feedback', path: '/app/feedback', icon: <MessageSquare className="w-4 h-4" /> },
  ];
