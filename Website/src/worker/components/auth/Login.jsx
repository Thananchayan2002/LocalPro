    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                // Check if error is account-related (blocked/denied/pending)
                if (errorMsg.includes('blocked') || errorMsg.includes('denied') || errorMsg.includes('pending')) {
            ...
            <div className="relative w-full max-w-md z-10">
                <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-10 border-2 border-purple-300/30">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 text-lg font-medium">Professionals Panel</p>
