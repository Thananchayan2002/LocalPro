...
export const Professionals = () => {
    ...
    const fetchPendingProfessionals = async () => {
        try {
            setLoading(true);
            const res = await fetch(`${API_BASE_URL}/api/professionals?status=pending&way=website`);
            const data = await res.json();
            if (data.success) {
    ...
    const fetchDeniedProfessionals = async () => {
        try {
            const res = await fetch(`${API_BASE_URL}/api/professionals?status=denied&way=website`);
            const data = await res.json();
            if (data.success) {
    ...
    const confirmStatusToggle = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/professionals/${id}/status`, {
                method: 'PATCH',
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/api/professionals/${editProfessional._id}`, {
                method: 'PUT',
                body: formData
            });
    ...
    const handleApproveSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/api/professionals/${approveProfessional._id}/approve`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const downloadPDF = async (professionalId, plainPassword) => {
        try {
            const res = await fetch(`${API_BASE_URL}/api/professionals/${professionalId}/pdf`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-sm">
                                ...
                                <div><strong>Username:</strong> {viewProfessional.username}</div>
