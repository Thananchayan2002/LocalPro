...
import { UserCog, Eye, EyeOff, CheckCircle2, XCircle, Info } from 'lucide-react';
...
export const Account = () => {
    ...
    const handleVerifySubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/auth/verify-credentials`, {
                ...
                body: JSON.stringify({ phone: verifyForm.currentPhone.trim(), password: verifyForm.currentPassword })
            });
            ...
            const verifiedPhone = data.phone || user?.phone || verifyForm.currentPhone;
    ...
    const handleFinalSubmit = async (e) => {
        ...
        const wantsPassword = passwords.newPassword && passwords.newPassword.trim() !== '';
        ...
        try {
            ...
            if (wantsPassword) {
                ...
                const currentPhoneForPasswordUpdate = wantsPhone ? (newPhone.trim()) : verifyForm.currentPhone.trim();

                console.log('Updating password with currentPhone:', currentPhoneForPasswordUpdate);
                ...
                if (!res2.ok) throw new Error(data2.message || 'Failed to update password');
            }
        ...
        <div className="mt-12 lg:mt-8 min-h-screen flex items-center justify-center">
            ...
            <div className="w-full max-w-3xl lg:max-w-2xl m-2 rounded-2xl bg-green-550">
                ...
                <div className="text-center mb-8 mt-2">
                    <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Account Settings</h1>
                    <p className="hidden lg:block text-gray-600">Manage your email and password securely</p>
                </div>
                        ...
                        <form onSubmit={handleVerifySubmit} className="space-y-6">
                            <div className="text-center mb-6">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 rounded-full border border-purple-200">
                                    ...
                                    <span className="text-sm font-medium text-purple-700">Verify your identity first</span>
                                </div>
                            </div>

                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-2">Current Phone Number</label>
                                <input
                                    type="tel"
                                    name="currentPhone"
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setVerifyForm({ currentPhone: user?.phone || '', currentPassword: '' })}
                        ...
                        <form onSubmit={handleFinalSubmit} className="space-y-6">
                            <div className="text-center mb-6">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 rounded-full border border-green-200">
                                    ...
                                    <span className="text-sm font-medium text-green-700">Verified — Choose what to update</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-purple-50 rounded-xl border border-purple-100">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    />
                                    <label htmlFor="updPhone" className="font-semibold text-gray-800 cursor-pointer">
                                        Update Phone Number
                                    </label>
                                </div>
                                ...
                                {updatePhoneChecked && (
                                    <div className="mt-3 animate-fadeIn">
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">New Phone Number</label>
                                        <input
                                            type="tel"
                                            value={newPhone}
                            ...
                            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                                <div className="mb-3">
                                    <label className="font-semibold text-gray-800">
                                        Update Password <span className="text-sm font-normal text-gray-500">(optional)</span>
                                    </label>
                                </div>
